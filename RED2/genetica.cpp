...
class poblacion{
	...
	public:
		...
		void mostrarResultado( double valorvars );
		void limpiar();
		int * fuerte();
		double checador();
...
int main( ){
	...
	for(int j = 0;j<tamPob;j++){
		...
		cout << "Creando primera poblacion: " << endl;
	...
	pobla.mostrarResultado(valorvars);
...
void poblacion::mostrarResultado( double valorvars ){
